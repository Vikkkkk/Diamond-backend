"""
This module Represents the table structure/Schema of Roles Table
"""
...
class Roles(Base):
    """**Summary:**
    This model class Represents the table structure/Schema of Roles Table
    """
    __tablename__ = 'roles'
    ...
    role_sub_modules = relationship('RolePermissions', back_populates='role')
