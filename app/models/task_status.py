"""
This module Represents the table structure/Schema of task_status Table
"""
...
class TaskStatus(Base):
    """**Summary:**
    This model class Represents the table structure/Schema of task_status Table
    """
    ...
    project_task = relationship("ProjectTask", back_populates="task_status")
